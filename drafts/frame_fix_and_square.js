/* grab filename from param input, go to unzipped folder, squares it and add delay to end frame, output to frame_fixed_square */
...
const outputPath = "./frame_fixed_square"
